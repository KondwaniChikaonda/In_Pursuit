...
export default function Contact() {
  return (
    <div className='p-3 items-center flex flex-col'>
      <h1 className='text-black text-3xl'> <strong>Contact Me!</strong> </h1>

      <div className='my-5'>

      <h3>Please do not hesitate to reach out for comments.. ❤️</h3>
      <p>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z"/></svg>
        yankhomhango@gmail.com</p>
      </div>

      <form action="">
      <textarea cols={50} rows={7} name="message" id="" placeholder='Message'></textarea>
      <br />
      <button className='my-5 bg-gray-400 px-6 py-2 text-white rounded-md'>Submit</button>
      </form>
